...
public class HttpFactory {
	...
	protected static final List<HttpHandler> httpSingletonList = new ArrayList<HttpHandler>();
	...
	public static HttpHandler newAuthenticatedConnection(Config config) {
	...
	private static HttpHandler getConnection(String address, Authentication credentials, Integer maxThreads) {
	...
	public Authentication getCredentials(String type, String key) {
		...
		if (type != null && key != null) {
			Authorization.setApiKey(ApiKeyConst.getApiKeyConst());
